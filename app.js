...
FirebaseTransport.prototype = {
  ...
  _basePath: function () { return 'rooms/net-' + this.room; },
...
/* The deck remembers which clues have been used. It outlives a single
   ...
   editing questions-network.js starts the memory over instead of pointing
...
function Launcher() {
  ...
  '<div class="launch"><div class="launch-inner">' +
    ...
    '<h1>FACE-OFF</h1>' +
    '<div class="sub">Network+ &nbsp;·&nbsp; N10-009 &nbsp;·&nbsp; Team Review</div>' +
...
function Host(forcedCode) {
  ...
  function topbar() {
    return '<div class="topbar">' +
      ...
      '<div class="t2">NETWORK+ · N10-009</div></div></div>' +
  ...
  function boardView() {
    ...
    if (!b.length) {
      return '<div class="wrap"><div class="card"><h2>No questions loaded</h2>' +
        '<div class="hint">Add categories to <span class="mono">questions-network.js</span>.</div></div></div>';
    }
      ...
      (function () {
        ...
        return '<div style="margin-top:16px"><label class="fld">What are we playing?</label>' +
          ...
          (have ? '' : '<div class="hint" style="margin-top:6px">' +
            'Add <span class="mono">acronyms-network.js</span> to enable the other two styles.</div>') +
        '</div>';
      })() +
  ...
  function _render() {
    if (!P) {
      app.innerHTML = '<div class="play"><div class="card" style="text-align:center">' +
        '<div class="brand" style="justify-content:center"><div class="mark">⚔</div><div><div class="t1">FACE-OFF</div><div class="t2">NETWORK+</div></div></div>' +
