/* =====================================================================
   FIREBASE CONFIG  —  Face-off: Network+
   ---------------------------------------------------------------------
   ...
   game writes to its own namespace (this one uses rooms/net-XXXX),
   so a Network+ room code can never collide with another game’s.
   ===================================================================== */
