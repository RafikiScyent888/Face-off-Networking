...
3. Name it something like `faceoff-network`. Click **Continue**.
...
5. You'll land on a screen showing a URL like
   `https://faceoff-network-default-rtdb.firebaseio.com/` — that's your `databaseURL`.
...
3. App nickname: `faceoff-net`. **Do not** check "Firebase Hosting". Click **Register app**.
...
const firebaseConfig = {
  ...
  authDomain: "faceoff-network.firebaseapp.com",
  databaseURL: "https://faceoff-network-default-rtdb.firebaseio.com",
  projectId: "faceoff-network",
  storageBucket: "faceoff-network.appspot.com",
